...
import { CheckCircle2, Settings, Shield, TrendingUp, User } from 'lucide-react';
                ...
                <div className='py-4'>
                    ...
                    <div className='mt-6 p-4 bg-muted/50 rounded-lg border'>
                        <p className='text-xs text-muted-foreground'>
                            You&apos;ll be redirected to Deriv&apos;s secure login page to authorize this application.
                            Your credentials are never shared with Benatradinghub.
                        </p>
                    </div>
                </div>
