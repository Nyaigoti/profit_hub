                        ...
                        <div className='flex items-center gap-2 sm:gap-3 flex-wrap'>
                            ...
                            <div className='flex items-center gap-2 text-sm'>
                                ...
                                <Select
                                    ...
                                    onValueChange={v => changeMaxTicks(Number.parseInt(v))}
                                >
                                    <SelectTrigger
                            ...
                            >
                                ...
                                <span
                                    className={`font-bold text-lg sm:text-2xl ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}
                                >
                            ...
                            >
                                ...
                                {currentDigit !== null ? (
                                    <span
                                        className={`text-base font-bold ${theme === 'dark' ? 'text-orange-400' : 'text-orange-600'}`}
                                    >
                                        {currentDigit}
                                    </span>
                                ) : (
                    ...
                    {connectionStatus !== 'connected' ? (
                        ...
                        <>
                            ...
                            <TabsContent value='pro-signals' className='mt-0'>
                                {analysis && (
                                    <ProSignalsTab proSignals={proSignals} analysis={analysis} theme={theme} />
                                )}
                            </TabsContent>
