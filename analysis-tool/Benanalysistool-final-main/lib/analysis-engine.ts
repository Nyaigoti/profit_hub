...
export class AnalysisEngine {
    ...
    generateSignals(): Signal[] {
        ...
        // Rise/Fall Signal
        signals.push(this.generateRiseFallSignal());
    ...
    private generateRiseFallSignal(): Signal {
    ...
    private generateProOverUnderSignal(analysis: AnalysisResult, recentDigits: number[]): Signal {
        ...
        if (digit0.percentage < 10 && digit1.percentage < 10) {
            ...
            const hasLeastIn01 =
                digit0.digit === analysis.powerIndex.weakest || digit1.digit === analysis.powerIndex.weakest;
        ...
        if (digit8.percentage < 10 && digit9.percentage < 10) {
            ...
            const hasLeastIn89 =
                digit8.digit === analysis.powerIndex.weakest || digit9.digit === analysis.powerIndex.weakest;
