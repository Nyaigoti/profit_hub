...
import { AnalysisEngine, type AnalysisResult, type Signal, type TickData } from '@/lib/analysis-engine';
import { type ConnectionLog, type DerivSymbol, DerivWebSocket } from '@/lib/deriv-websocket';
