...
export function OverUnderTab({ analysis, recentDigits, theme = 'dark' }: OverUnderTabProps) {
        ...
        <div className='space-y-6'>
            ...
            >
                ...
                <div className='text-center'>
                    ...
                    <div
                        className={`text-sm sm:text-base font-medium ${theme === 'dark' ? 'text-cyan-400' : 'text-cyan-700'}`}
                    >
                        {hasSignal
                    ...
                    {hasSignal && (
                        <div
                            className={`mt-2 text-xs sm:text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}
                        >
                            Market Power: {signalType === 'Over' ? overPercent.toFixed(1) : underPercent.toFixed(1)}% -
                            Strong {signalType} bias detected and increasing
                        </div>
                    )}
                </div>
            </div>
            ...
            >
                ...
                <div className='space-y-3'>
                    <h4
                        className={`text-lg font-semibold text-center ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}
                    >
