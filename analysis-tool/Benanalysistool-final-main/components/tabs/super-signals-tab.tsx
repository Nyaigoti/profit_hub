...
import { Activity, ScrollText, Zap } from 'lucide-react';
        ...
        <div className='space-y-6'>
            ...
            >
                ...
                <p className={`text-sm mb-6 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-700'}`}>
                    Continuous real-time monitoring across all volatilities. Signals update automatically every 2
                    seconds based on market conditions, pattern strength, and trade validity.
                </p>
                ...
                {showLogs && (
                    ...
                    >
                        <h3
                            className={`text-sm font-bold mb-2 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-900'}`}
                        >
                            Scan Logs
                        </h3>
                ...
                {superSignals.length === 0 ? (
                    <div className='text-center py-12'>
                        <Zap
                            className={`h-16 w-16 mx-auto mb-4 ${theme === 'dark' ? 'text-gray-600' : 'text-gray-400'}`}
                        />
                            ...
                            >
                                ...
                                <div className='space-y-2 mb-3'>
                                    ...
                                    <div className='flex items-center justify-between text-sm'>
                                        ...
                                        <span
                                            className={`font-bold ${theme === 'dark' ? 'text-emerald-400' : 'text-emerald-600'}`}
                                        >
