    ...
    const scanAllStrategies = (): AISignalResult => {
        ...
        const strategies = [
            ...
            },
            {
                name: 'Differs',
                confidence:
                    100 - (analysis.digitFrequencies.sort((a, b) => a.percentage - b.percentage)[0]?.percentage || 10),
                signal: 'DIFFERS',
                ...
                >
                    <div className='grid grid-cols-2 gap-4 text-center'>
                        <div>
                            ...
                            <div
                                className={`text-lg sm:text-2xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}
                            >
                ...
                >
                    ...
                    <div className='space-y-4'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                            ...
                            >
                                <div
                                    className={`text-xs sm:text-sm mb-2 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}
                                >
                                    Best Market
                                </div>
                                <div
                                    className={`text-lg sm:text-xl font-bold ${theme === 'dark' ? 'text-cyan-400' : 'text-cyan-600'}`}
                                >
                            ...
                            >
                                ...
                                <div
                                    className={`text-lg sm:text-xl font-bold ${theme === 'dark' ? 'text-blue-400' : 'text-blue-600'}`}
                                >
                        ...
                        >
                            ...
                            <div
                                className={`text-sm sm:text-base ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}
                            >
